...
export function canAccessPath(pathname, user = getStoredUser()) {
  ...
  if (hasRole(user, ROLES.MANAGER)) {
    ['/clients', '/subscriptions', '/visits', '/leads', '/trials', '/master-classes', '/certificates', '/tasks', '/dictionaries', '/export', '/groups', '/schedule', '/finance', '/daily-payments', '/employee-schedule', '/employee-worklog', '/employees', '/chat', '/settings'].forEach((path) => allowedPaths.add(path));
  }
  ...
  if (hasRole(user, ROLES.ACCOUNTANT)) {
    ['/clients', '/subscriptions', '/visits', '/trials', '/master-classes', '/certificates', '/finance', '/daily-payments', '/employee-schedule', '/employee-worklog', '/payroll', '/reports', '/export', '/chat', '/settings'].forEach((path) => allowedPaths.add(path));
  }
