...
const fields = [
  ...
  { name: 'stage', label: 'Этап', type: 'select', options: [{ value: 'lead', label: 'Лид' }, { value: 'booked', label: 'Записался на пробный' }, { value: 'attended', label: 'Прошел пробный' }, { value: 'bought', label: 'Купил абонемент' }, { value: 'lost', label: 'Не купил' }, { value: 'new', label: 'Новый' }, { value: 'scheduled', label: 'Запланирован' }, { value: 'completed', label: 'Завершён' }, { value: 'cancelled', label: 'Отменён' }] },
...
export default function TrialsPage() {
  ...
  return (
    <>
      ...
      <Filters>
        <SelectField label="Этап" value={crud.filters.stage} onChange={(value) => crud.setFilters({ ...crud.filters, stage: value })} options={[{ value: '', label: 'Все' }, { value: 'lead', label: 'Лид' }, { value: 'booked', label: 'Записался на пробный' }, { value: 'attended', label: 'Прошел пробный' }, { value: 'bought', label: 'Купил абонемент' }, { value: 'lost', label: 'Не купил' }, { value: 'new', label: 'Новый' }, { value: 'scheduled', label: 'Запланирован' }, { value: 'completed', label: 'Завершён' }, { value: 'cancelled', label: 'Отменён' }]} />
      ...
      <Table data={crud.items} columns={[
        ...
        { key: 'stage', header: 'Этап', render: (row) => <Badge value={row.stage ?? row.status} /> },
